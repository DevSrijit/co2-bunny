...
import { DataTransferResult, EnergySourceResult, TrafficResult } from "@/types/api"

type IndividualResults = {
  dataTransfer?: DataTransferResult
  energySource?: EnergySourceResult
                        ...
                        {individualResults.dataTransfer && (
                            <div className="mt-12 space-y-8">
                                ...
                                <div className="grid grid-cols-1 gap-6">
                                    ...
                                    {individualResults.energySource && (
                                        <div className="rounded-lg border p-6">
